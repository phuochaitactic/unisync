...
@Component({
  selector: "app-danhsach-lichsu",
  templateUrl: "./danhsach-lichsu.component.html",
  styleUrls: ["./danhsach-lichsu.component.css"],
})
export class DanhsachlichsuComponent {
  dataNHHK: any;
  stt = 0;
  ...
  onClickDetail(id: any) {
    console.log("ngayBatdau", this.selectedYear_Semester.ngayBatDau);
    console.log("ngayKetthuc", this.selectedYear_Semester.ngayKetThuc);
      this.router.navigate([
        "dashboard/giangvien/lichsuduyet",
        {
          id: id,
          ngayBatDau: this.selectedYear_Semester.ngayBatDau,
          ngayKetThuc: this.selectedYear_Semester.ngayKetThuc,
        },
      ]);
  }
  ...
  dataLichDuyet = [
    ...
    },
    {
      ...
      ngayKetThuc: "2024-03-12T00:00:00",
    },
  ];
}
