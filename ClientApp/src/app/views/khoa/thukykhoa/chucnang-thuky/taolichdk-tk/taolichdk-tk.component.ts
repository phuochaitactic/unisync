...
@Component({
  selector: "app-taolichdk-tk",
  templateUrl: "./taolichdk-tk.component.html",
  styleUrls: ["./taolichdk-tk.component.css"],
})
export class TaolichdkTkComponent implements OnInit {
