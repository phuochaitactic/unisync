...
@Component({
  selector: "app-danhsachhdnk-tk",
  templateUrl: "./danhsachhdnk-tk.component.html",
  styleUrls: ["./danhsachhdnk-tk.component.css"],
})
export class DanhsachhdnkTkComponent implements OnInit {
