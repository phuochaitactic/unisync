...
@Component({
  selector: "app-sinhvienctdt",
  templateUrl: "./sinhvienctdt.component.html",
  styleUrls: ["./sinhvienctdt.component.css"],
})
export class SinhvienctdtComponent implements OnInit {
