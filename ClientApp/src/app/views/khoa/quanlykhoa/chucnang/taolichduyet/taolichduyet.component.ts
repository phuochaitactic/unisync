...
@Component({
  selector: "app-taolichduyet",
  templateUrl: "./taolichduyet.component.html",
  styleUrls: ["./taolichduyet.component.css"],
})
export class TaolichduyetComponent {
