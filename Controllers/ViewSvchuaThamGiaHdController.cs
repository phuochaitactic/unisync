...
namespace BuildCongRenLuyen.Controllers
{
    ...
    [ApiController]
    public class ViewSvchuaThamGiaHdController : ControllerBase
    {
        protected readonly IViewSvchuaThamGiaHdService _service;
        protected readonly IAuthService _auth;

        public ViewSvchuaThamGiaHdController(IViewSvchuaThamGiaHdService service, IAuthService auth)
        {
            this._service = service;
            this._auth = auth;
        }

        // GET: api/<ViewSvchuaThamGiaHdController>
        [HttpGet]
